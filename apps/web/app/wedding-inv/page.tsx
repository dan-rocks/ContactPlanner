		...
		<div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-[90vh] sm:min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
			...
			<main className="flex flex-col gap-8 row-start-2 items-center min-h-full">
				...
				<div className="text-sm text-center font-[family-name:var(--font-geist-mono)]">
					...
					<div>If you clicked on this you are invited to our wedding!</div>
				</div>
				...
				<div className="flex flex-row gap-4 justify-between items-center w-full">
					...
					<a
						className="rounded-full border border-solid border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:min-w-112"
						href="wedding-inv/VENMO"
						rel="noopener noreferrer"
					>
						VENMO
					</a>
				...
				<div className="w-full flex justify-center">
					<a
						className="flex border-black/[.08] items-center justify-center dark:border-white/[.145] border rounded-full border-solid transition-colors w-full h-10 hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] hover:border-transparent text-sm sm:text-base sm:h-12"
						href="https://www.amazon.com/wedding/registry/BRA7NQUI9B6?ref=wr_search_page_result_8"
						target="_blank"
					>
						Registry
					</a>
